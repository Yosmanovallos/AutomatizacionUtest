# Autor: Yosman Ovallos
  ...
  Feature: A user enters the Utest page to register
    ...
    Scenario: Register user Yosman on the utest page
      ...
      |Yosman   |Ovallos   |prueb4fgdda3@correo.com|February |5  |1996|Cucuta|540001   |Colombia|k0cZ*f5iW!N3|Linux   |Ubuntu |Spanish |Samsung|Galaxy S8 Plus|Android 10 |
